  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          className={`w-full rounded-xl border border-[color:var(--border)] bg-[color:var(--card)] px-4 py-2 text-[color:var(--foreground)] outline-none transition-all placeholder:text-[color:var(--foreground)]/50 focus:border-[color:var(--primary)] focus:ring-2 focus:ring-[color:var(--primary)]/30 ${icon ? 'pl-10' : ''} ${error ? 'border-red-500 focus:ring-red-500' : ''} ${className}`}
          {...props}
        />
      </div>
      {error && (
