...
export default function EditCoursePage() {
  ...
  useEffect(() => {
    ...
    if (courseId) {
      ...
      if (course) {
        // Only allow the owner instructor to edit
        ...
        if (course.whatYouLearn?.length) setWhatYouLearn(course.whatYouLearn);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorageService.updateCourse(courseId, updates);
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto bg-gray-50 dark:bg-[#0a0a0a]">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">Edit Course</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Update the details and content of your published course.</p>
        </div>
